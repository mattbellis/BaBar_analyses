...
createsmpmaker BetaMiniPhysicsSequence my_fakeB_$b2$l0 {
  debug              set f
  verbose            set f
  decayMode          set "dummy00_1 -> $b1 $ab1"
...
#################################################################
################# NEW #####################################
createsmpsublister BetaMiniPhysicsSequence subXlistComp_$b2$l0 {
  unrefinedListName set "my_fakeB_$b2$l0"
  isCloneOfListName set "myB_con$b2$l0"
...
foreach lep $leptons {
  ...
  talkto BtuTupleMaker_$b2$l0 {
    ...
    ntpBlockContents set "dummy     : Mass Momentum CMMomentum MCIdx Vertex VtxChi2 UsrData(my_fakeB_$b2$l0) ShapeVars"
