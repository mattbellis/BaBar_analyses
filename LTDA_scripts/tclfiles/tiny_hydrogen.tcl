...
createsmpmaker BetaMiniPhysicsSequence mytinyH_unc {
  debug              set f
  verbose            set f
  decayMode          set "n0 -> p+ e-"
  ...
  fittingAlgorithm   set "TreeFitter"
  fitConstraints     set "Geo"
  preFitSelectors    set "Mass    0.5:1.2"
...
###### Constrained
createsmprefitter BetaMiniPhysicsSequence mytinyH_con {
  debug              set f
  verbose            set f
  decayMode          set "n0 -> p+ e-"
  #daughterListNames  set "pCombinedSuperLoose"
  ...
  unrefinedListName  set "mytinyH_unc"
  fittingAlgorithm   set "TreeFitter"
  fitConstraints     set "Geo"
  #fitSettings        set "InvalidateFit"
  fitSettings        set "UpdateDaughters"
  preFitSelectors    set "Mass    0.0:1.2"
  #preFitSelectors    set "DeltaE -1.0:1.0"
  #preFitSelectors    set "Mes"
  preFitSelectors    set "Mmiss"
  postFitSelectors   set "Mass"
...
createsmpmerger BetaMiniPhysicsSequence AlltinyH {
  inputListNames    set "mytinyH_unc"
  inputListNames    set "mytinyH_con"
  disableCloneCheck set true
...
## Add Analysis module
#####################################################################
  mod  clone  BtuTupleMaker BtuTupleMaker_tinyH
  path append Everything BtuTupleMaker_tinyH

  talkto BtuTupleMaker_tinyH {

    ntupleName set ntp_tinyH
    listToDump set AlltinyH
    ...
    ntpBlockConfigs set "n0         n             2   100"
    #ntpBlockConfigs set "Lambda0    Lambda0       2   20"

    ntpBlockContents set "n         : Mass Momentum CMMomentum MCIdx Vertex VtxChi2 UsrData(mytinyH_unc) ShapeVars"
    ...
    ntpAuxListContents set "n       : mytinyH_con: _con_ : Mass Momentum CMMomentum Vertex VtxChi2 UsrData(mytinyH_con)"
