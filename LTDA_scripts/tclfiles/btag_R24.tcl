...
talkto myList {
    ...
    inputListNames set B0ToDstarPiDefault
    inputListNames set DstarHardLoose

    # Kshort
    #inputListNames set KsLoose

    #inputListNames set D0ToKPiLoose
    #inputListNames set D0ToKPiPi0Loose

    #inputListNames set pi0VeryLoose
...
talkto BtuTupleMaker {
    ...
    ntpBlockContents set "B0   :  Mass Momentum CMMomentum Vertex VtxChi2"

    #ntpBlockConfigs set "D0        D0  2       50000"
    #ntpBlockContents set "D0   :  Mass Momentum CMMomentum Vertex VtxChi2"

    #ntpBlockConfigs set "pi0        pi0  2       50000"
    #ntpBlockContents set "pi0   :  Mass Momentum CMMomentum Vertex VtxChi2"
    ...
    ##ntpBlockContents set "K_S   :  Mass Momentum CMMomentum Vertex VtxChi2 UsrData(Ks_Pid)"
    #ntpBlockContents set "K_S   :  Mass Momentum CMMomentum Vertex VtxChi2"
