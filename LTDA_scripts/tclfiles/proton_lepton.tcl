...
seq create SmpMyB_mu
seq create SmpMyB_e

# muon
mod clone SmpMakerDefiner myB_mu
seq append SmpMyB_mu myB_mu
catch { setProduction myB_mu }

# electron
mod clone SmpMakerDefiner myB_e
seq append SmpMyB_e myB_e
catch { setProduction myB_e }
...
## Add Analysis module
##
path append Everything SmpMyB_mu
path append Everything SmpMyB_e
...
talkto BtuTupleMaker_mu {
    ...
    ntpBlockContents set "B         : Mass Momentum CMMomentum MCIdx Vertex VtxChi2 UsrData(myB_mu) ShapeVars"
